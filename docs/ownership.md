...
| Authorized image projection/mutation/creation -> GraphImageService | Image projection/mutation/creation binding executor | current: `src/callable/` | Owns boundary typing/version-token/error translation and the create-lane authority/id-minting; GraphImageService owns the image write itself. |
