...
contents collection. The reached `XMLTokenizer>>nextEndTag` method (`t01`) begins closing-tag
parsing, then reaches the omitted `XMLTokenizer>>nextTrimmedBlanksUpTo:` reader (`2fg`) on SAXDriver.
