#!/usr/bin/env bash
# Rebuild host-values.component.wasm from the Rust source in this directory.
#
...
wasm-tools component new \
  target/wasm32-unknown-unknown/release/lagrange_host_reader.wasm \
  -o host-values.component.wasm
...
wasm-tools component wit host-values.component.wasm
