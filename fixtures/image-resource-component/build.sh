#!/usr/bin/env bash
# Rebuild image-resource.component.wasm from the Rust source in this directory.
#
...
wasm-tools component new \
  target/wasm32-unknown-unknown/release/lagrange_image_reader.wasm \
  -o image-resource.component.wasm
...
wasm-tools component wit image-resource.component.wasm
